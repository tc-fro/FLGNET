...
class Net(nn.Module):
    ...
    def forward(self, x):
        ...
        edge, p4, p3, p2, p1= self.eam(x4, x3, x2, x1)
        ...
        x4f = self.cam4(x4r, p4)
        x34 = self.cam3(x3r, x4f, p3)
        x234 = self.cam2(x2r, x34, p2)
        x1234 = self.cam1(x1r, x234, p1)
